...
<?php
	...
	if (isset($_POST['submit']))
	{
		...
		{
			mySQL_query("INSERT INTO user (firstname,lastname,username,username2,day,year,birthday,gender,number,email,email2,password,password2)
			VALUES ('$firstname','$lastname','$username','$username2','$day','$year''$birthday','$gender','$number','$email','$email2','$password','$password2')")
			or die (mySQL_error());
